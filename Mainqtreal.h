...
//unsigned char y_color_out_shi[HXSIZE][WYSIZE];//320*240

//////
////Sobel
//void SQIchangeSobel_shih(unsigned char *input, unsigned char *output);
//unsigned char Iresult[HXSIZE][WYSIZE];//
...
//unsigned char drawy_color[HXSIZE_in][WYSIZE_in];//
///*
...
//                 2247,2996,3745,4494,3745,2996,2247,
//                 1498,2247,2996,3745,2996,2247,1498,
//                 748,1498,2247,2996,2247,1498,748,};// */
//    int SQ,SQ2;
...
//    for(i=10;i<(HXSIZE-10);i=i+1)//SQI
//    {
...
//            sum=Dintegrate(integrate_SQI,i-3,j-3  ,SQ-1,SQ-1      );//
...
//   const int Lv2TrainFrame=1;		// (1) Lv2 H2 (0)
///////
...
///////
//    static bool innersearch_FirstIn_shi=1;// Lv2
//    static int TH2Record_shih=0;
//    static int frame_count_lv2_shi=0;//
//    static int thresh_store_shi=0;// od thresh
...
//        //{
//        count1=0;
//         for(i=innerH1;i<(innerH2)-SBHI;i++) //Search
//         {
